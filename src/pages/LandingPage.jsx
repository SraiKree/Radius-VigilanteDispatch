...
function LandingPage() {
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        // Set admin mode based on role selection before navigating
                        ...
                        <div className="bg-zinc-900 border border-zinc-800 shadow-2xl z-10 w-full space-y-6 rounded-2xl p-6 lg:p-10 backdrop-blur-md relative">
                            ...
                            <div className="space-y-4">
                                <form onSubmit={handleLogin} className="mb-4 space-y-4">
                                    ...
                                    <button type="submit" className="btn btn-lg bg-red-600 hover:bg-red-700 text-white border-none w-full h-14 rounded-xl font-bold shadow-lg shadow-red-900/20 transition-all">
                                        Initialize Command
                                    </button>
                                </form>
                                <p className="text-zinc-500 mb-4 text-center text-sm">
                                    New on our platform?{' '}
                                    <a href="#" className="text-red-500 hover:text-red-400 transition-colors">Request Clearance</a>
                                </p>
